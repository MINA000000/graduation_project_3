...
class HandymanSignupGoogle extends StatefulWidget {
  @override
  _HandymanSignupGoogleState createState() => _HandymanSignupGoogleState();
}
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: isloading2?null:() async{
                              ...
                              try{
                                ...
                                Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_)=>Rest()), (route)=>false);
                            ...
                            child:isloading2?CircularProgressIndicator(color: Colors.white):Row(
